            ...
            <div class="row justify-content-center mt-5">
                <div class="col-12">
                    <div class="row lot-row">
                        ...
                        <div class="col-6 d-flex justify-content-center col-5 col-lot-box">
                    ...
                    <div class="row">
                        <div class="col-md-5 mb-3" wire:ignore>
                            <div class="card lot-card">
                                ...
                                <a class="prev" onclick="plusSlides(-1)"><img class="img-fluid lot-thumbnail cursor" src="{{ asset('images/wbbonline_btn_55.png') }}" alt="next-button"></a>

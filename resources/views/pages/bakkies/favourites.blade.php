                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-7">
                                            <p class="specifications-span">{{ $favourite->lot->vehicle->year }}</p>
                                            <p class="specifications-span">{{ $favourite->lot->vehicle->body_type }}</p>
                                            <p class="specifications-span">{{ $favourite->lot->vehicle->mileage }} km</p>
                                            <p class="specifications-span">{{ $favourite->lot->vehicle->fuel_type }}</p>
                                            <p class="specifications-span">{{ $favourite->lot->vehicle->transmission }}</p>
                                            <p class="specifications-span">{{ $favourite->lot->vehicle->color }}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-3">

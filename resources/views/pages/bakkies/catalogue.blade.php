            ...
            @if(Auth::user()->status == 'Active')
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 col-xl-4">
                    ...
                    <div class="col text-center mt-2">
                        <a class="view-fav-btn" href="{{ route('favourites', 'favourite') }}"> <img loading="lazy" class="img-fluid" src="{{ asset('images/wbbonline_btn_27.png') }}" alt="favourites"></a>
                    </div>
                </div>
